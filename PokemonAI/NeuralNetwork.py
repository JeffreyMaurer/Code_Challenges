...
class NeuralNetwork:
    ...
    def train_replay_batch(self, replays, batch_size, epoch=100, lr=0): # s, a, r, s'
        lr = self.lr if lr == 0 else lr
        for i in range(epoch):
            ...
            errors[np.arange(batch_size),attack_indices] = rewards - Q_values[np.arange(batch_size),attack_indices]
